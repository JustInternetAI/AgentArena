...
from agent_runtime.agent import Action, Agent
...
def create_tool_dispatcher() -> ToolDispatcher:
    ...
    def check_inventory() -> dict:
        ...
        return {"success": True, "inventory": {"wood": 5, "stone": 3, "food": 2}, "total_items": 10}
...
class EnhancedAgent(Agent):
    ...
    def __init__(
        ...
        super().__init__(agent_id=agent_id, backend=backend, tools=available_tools, goals=goals)
            ...
            try:
                ...
                try:
                    ...
                    if tool_match:
                        ...
                        reconstructed = {"tool": tool, "params": params}
...
def test_scenario_2_navigation():
    ...
    agent.perceive(
        {"position": {"x": 0, "y": 0}, "target_location": {"x": 10, "y": 15}, "obstacles": []},
        source="navigation",
    )
