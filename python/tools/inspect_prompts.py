"""
CLI tool for viewing LLM prompts and responses captured by the Prompt Inspector.

Usage:
    python -m tools.inspect_prompts --agent agent_001 --tick 42
    python -m tools.inspect_prompts --agent agent_001 --tick-range 40-50
    python -m tools.inspect_prompts --all --tick-range 0-100
...
def main():
    parser = argparse.ArgumentParser(
        description="View LLM prompts and responses captured by the Prompt Inspector",
...
Examples:
  ...
  python -m tools.inspect_prompts --all --verbose
